...
start_server() {
    ...
    # "$JAVACMD" -server -Xms512M -Xmx2048M  -XX:+CMSClassUnloadingEnabled -XX:ParallelGCThreads=2 -XX:MinHeapFreeRatio=5 -XX:MaxHeapFreeRatio=10 -jar FTBServer-1.7.10-1614.jar nogui
    "$JAVACMD" -server -Xms512M -Xmx1024M -jar FTBServer-1.7.10-1614.jar nogui
}
